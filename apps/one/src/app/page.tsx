      ...
      <main className="relative z-10">
        ...
        <section className="py-40 px-6 md:px-12 relative overflow-hidden bg-[#0A0A0A]">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <Link href="https://one.transformateck.com/login" className="inline-flex px-12 py-6 bg-[#7C3AED] text-white rounded-full font-black text-sm uppercase tracking-[0.2em] hover:scale-105 hover:shadow-[0_0_50px_rgba(124,58,237,0.5)] transition-all duration-300">
