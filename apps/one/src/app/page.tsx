      ...
      <main className="relative z-10">
          ...
          <div className="max-w-[1400px] mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="lg:col-span-6 z-10">
              ...
              <motion.div variants={fadeUp} className="flex flex-wrap items-center gap-4">
                <Link href="/cuenta" className="px-10 py-5 bg-[#7C3AED] text-white rounded-full font-black text-xs uppercase tracking-[0.2em] flex items-center gap-3 hover:shadow-[0_0_40px_rgba(124,58,237,0.5)] transition-all duration-300">
        ...
        <section className="py-40 px-6 md:px-12 relative overflow-hidden bg-[#0A0A0A]">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <Link href="/cuenta" className="inline-flex px-12 py-6 bg-[#7C3AED] text-white rounded-full font-black text-sm uppercase tracking-[0.2em] hover:scale-105 hover:shadow-[0_0_50px_rgba(124,58,237,0.5)] transition-all duration-300">
        ...
        <footer className="bg-[#050505] pt-20 pb-12 px-6 md:px-12 border-t border-white/5 relative z-10">
          <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="flex flex-wrap justify-center gap-8 text-[10px] font-black uppercase tracking-widest text-white/50">
               ...
               <Link href="/cuenta" className="hover:text-[#7C3AED] transition-colors">Cuenta</Link>
