...
const ADMINS_MOCK = [
  { id: 'A001', nombre: 'Kevin Salazar', email: 'admin@transsync.mx', tel: '81 1234 5678', rol: 'Admin', estado: 'active', fecha: '2023-11-15T10:00:00Z' },
  { id: 'A002', nombre: 'Misael Garza Rosas', email: 'misael@transsync.mx', tel: '81 8765 4321', rol: 'Dispatcher', estado: 'active', fecha: '2024-01-10T09:30:00Z' },
  { id: 'A003', nombre: 'Andrea Lomas', email: 'andrea@transsync.mx', tel: '81 1122 3344', rol: 'Manager', estado: 'active', fecha: '2024-02-05T14:20:00Z' },
  { id: 'A004', nombre: 'Juan Perez', email: 'juan@transsync.mx', tel: '81 5566 7788', rol: 'Viewer', estado: 'suspended', fecha: '2023-12-01T11:15:00Z' },
];
                    ...
                    <div className="val-q mt-6">
                      <div className="flex gap-4">
                        <div className="val-field flex-1">
                          ...
                          <input type="email" name="email" value={formData.email} onChange={handleChange} className="val-select" placeholder="admin@transsync.mx" required/>
                        </div>
                        <div className="val-field flex-1">
