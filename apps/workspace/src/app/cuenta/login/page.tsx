...
import { Mail, Lock, ChevronRight, Layers } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6">
      ...
      <div className="flex items-center gap-3 mb-10">
        ...
        <div>
          <h2 className="text-xl font-black uppercase tracking-tighter text-white">Consola B2B</h2>
          <p className="text-[10px] font-bold text-white/40 uppercase tracking-widest">Acceso Industrial</p>
        </div>
      </div>
      ...
      <div className="mt-8 pt-8 border-t border-white/5 text-center">
        <Link href="#" className="text-[10px] font-black uppercase tracking-[0.2em] text-white/20 hover:text-[#4ECCA3] transition-colors">
          Solicitar acceso Maestro
        </Link>
      </div>
    </motion.div>
    </div>
