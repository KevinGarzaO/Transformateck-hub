  ...
  >
    <div className="max-w-[1400px] mx-auto flex items-center justify-between">
      ...
      <div className="flex items-center gap-4">
         <a href="http://localhost:3002" className="px-6 py-3 bg-[#7C3AED] text-white text-xs font-black uppercase tracking-widest rounded-full hover:shadow-[0_0_30px_rgba(124,58,237,0.4)] transition-all duration-300">
            One
         </a>
          ...
          <div className="max-w-[1400px] mx-auto">
            ...
            >
              <div className="lg:w-1/2 p-12 md:p-20 relative z-10">
                ...
                <a href="http://localhost:3002" className="inline-flex items-center justify-center w-full sm:w-auto px-10 py-5 bg-white text-[#050505] rounded-full font-black text-xs uppercase tracking-widest hover:bg-[#7C3AED] hover:text-white transition-all duration-300">
                  Entrar a One
                </a>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
              ...
              <div>
                ...
                <ul className="space-y-4 font-bold text-sm">
                  ...
                  <li><a href="http://localhost:3002" className="text-white/60 hover:text-white transition-colors">One (Creadores)</a></li>
                </ul>
              </div>
