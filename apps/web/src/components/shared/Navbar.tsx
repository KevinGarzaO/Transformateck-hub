...
export function Navbar() {
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 p-4 sm:p-6 px-4 sm:px-8 md:px-16 z-50 bg-[#050505]/80 backdrop-blur-xl border-b border-white/5"
    >
      <div className="max-w-[1400px] mx-auto flex items-center justify-between gap-2 sm:gap-6">
        <Link href="/" className="flex items-center gap-3 flex-shrink-0">
          <Image
            ...
            height={32}
          />
          <span className="text-xl font-black tracking-tighter text-white hidden sm:block">Transformateck</span>
        </Link>
